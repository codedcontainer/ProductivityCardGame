...
class CardPile:
    ...
    def sort_ascending(self):
        """sorts all cards by value starting with the smallest value"""
    ...
    def print_cards(self):
        """print all cards as a string"""
        cards = [Card.as_string(card) for card in self.cards]
        return ",".join(cards)

    @property
    def print_sum_value(self):
        """print the sum card values as a string"""
